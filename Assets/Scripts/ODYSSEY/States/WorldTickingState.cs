...
namespace Odyssey
{
    public class WorldTickingState : IState
    {
        ...
        public void Update()
        {
            ...
            bool showUIForHovered = !thirdPersonController.IsControlling && !minimapDriver.IsExpanded();
